  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item me-3">
      <form action="#" method="get">
        <input type="text" class="form-control rounded-pill" placeholder="Search Films" name="query" style="max-width:200px;">
      </form>
    </li>

    <li class="nav-item">
      <form action="#" method="get">
        <input type="text" class="form-control rounded-pill" placeholder="Search Acteurs" name="query" style="max-width:200px;">
      </form>
    </li>
